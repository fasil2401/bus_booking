...
class RemoteServicesDriverList {
  Future<DriverList?> getDriverList() async {
    final response = await http.get(Uri.parse('${baseUrl}DriverApi/${loginController.urlId.value}/'),
...
// loginController.refresh();
      return driverListFromJson(responseString);
